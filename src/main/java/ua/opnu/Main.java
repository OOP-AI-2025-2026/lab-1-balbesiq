...
public class Main {
    ...
    public boolean array123(int[] nums) {
        for (int i = 0; i < nums.length - 2; i++) { // stop 2 before end
    ...
    public String lastTwo(String str) {
        if(str.length()<2)
            ...
            String prelastOfWord = str.substring(str.length()-2,str.length()-1);
            String lastOfWord  = str.substring(str.length()-1);
            return (beginningOfWord + lastOfWord + prelastOfWord);
        }
    }
    ...
    public String middleTwo(String str) {
        if(str.length()<2)
            ...
            String firstMidPart = str.substring((str.length() / 2) - 1, str.length() / 2);
            String secondMidPart = str.substring(str.length() / 2, (str.length() / 2) + 1);
        return (firstMidPart+secondMidPart);
        }
    }
